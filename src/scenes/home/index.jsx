  ...
  return (
    <div className="main_container">
     ...
     <div className="sub_head">
      Discover the best tips for caring for your indoor plants.Moisture, light, temperature...Choose the plant that best suits your home.
      </div>
